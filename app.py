...
with tab1:
    ...
    with col_ctrl:
        ...
        **Note:** As the sample size ($n$) increases, the sampling distribution 
        of the mean $(\\bar{{x}})$ will increasingly resemble a normal distribution, 
    ...
    with col_plot:
        ...
        fig2.update_layout(height=400, title=fr"Sampling Distribution of $\bar{{x}}$ (n={l_n})", margin=dict(t=30, b=0), showlegend=False)
        st.plotly_chart(fig2, width='stretch')
        
        # Display Stats with the SE formula comparison
